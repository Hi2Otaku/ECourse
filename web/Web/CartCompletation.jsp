<%-- 
    Document   : CartCompletation
    Created on : Jun 20, 2024, 8:34:00 AM
    Author     : hi2ot
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Order Completed</h1>
        ...
        <div class="container-fluid py-5">
            <div class="container py-5 text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">                        
                        <h1 class="display-1">Order Completed!</h1>                        
                        <p class="mb-4">Courses have been added to your profile!</p>                        
                    </div>
                </div>
            </div>
        </div>
