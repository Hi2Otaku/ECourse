<%-- 
    ...
    Created on : Jul 9, 2024, 4:10:33 PM
    Author     : hi2ot
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Create Question</h1>
        </div>                
                ...
                <div class="counter bg-white rounded p-5">                    
                    ...
                    <form action="CreateQuestion" method="post">
                        ...
                        <table style="width: 80%">
                            <tr>
                                <th>ID: </th>
                                <td><input type="text" name="QuestionID" value="${curQues.getQuestionID()}" readonly="true" class="form-control border-2 px-4"> </td>
                            </tr>
                            <tr>
                                <th>Question: </th>
                                <td><input type="text" name="Question" value="${curQues.getQuestion()}" class="form-control border-2 px-4" required="true"></td>
                            </tr>
                            <tr>
                                <th>Answer 1: </th>
                                <td><input type="text" name="Answer1" value class="form-control border-2 px-4" required="true"></td>
                                <td style="width: 10px"><input type="radio" name="Correct" value="1" style=" margin-top: 10px" required="true"></td>
                            </tr>
                            <tr>
                                <th>Answer 2: </th>
                                <td><input type="text" name="Answer2" value class="form-control border-2 px-4" required="true"></td>
                                <td style="width: 10px"><input type="radio" name="Correct" value="2" style=" margin-top: 10px" required="true"></td>
                            </tr>
                            <tr>
                                <th>Answer 3: </th>
                                <td><input type="text" name="Answer3" value class="form-control border-2 px-4" required="true"></td>
                                <td style="width: 10px"><input type="radio" name="Correct" value="3" style=" margin-top: 10px" required="true"></td>
                            </tr>
                            <tr>
                                <th>Answer 4: </th>
                                <td><input type="text" name="Answer4" value class="form-control border-2 px-4" required="true"></td>
                                <td style="width: 10px"><input type="radio" name="Correct" value="4" style=" margin-top: 10px" required="true"></td>
                            </tr>                            
                            <tr>
                                <th>Explain: </th>
                                <td ><input type="text" name="Explain" value="${curQues.getExplaination()}" class="form-control border-2 px-4" required> </td>
                            </tr>                            
                        </table>
                        <input type="submit" name="create" value="Create" class="btn btn-primary text-white border-2 border-secondary" style="margin: 20px">
                    </form>
                </div>
            </div>
