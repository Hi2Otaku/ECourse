<%-- 
    ...
    Created on : Jul 10, 2024, 3:44:58 PM
    Author     : hi2ot
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Create Lesson</h1>
        </div>                
                ...
                <div class="counter bg-white rounded p-5">           
                    <form action="CreateLesson" method="post">
                        ...
                        <table style="width: 80%">
                            <tr>
                                <th>Lesson ID: </th>
                                <td><input type="text" name="LessonID" value readonly="true" class="form-control border-2 px-4"></td>
                            </tr>
                            <tr>
                                <th>Lesson Name: </th>
                                <td><input type="text" name="LessonName" value class="form-control border-2 px-4" required="true"> </td>
                            </tr>
                            <tr>
                                <th>Description: </th>
                                <td><input type="text" name="Description" value class="form-control border-2 px-4" required="true"> </td>
                            </tr>
                        </table>
                        <input type="submit" name="create" value="Create" class="btn border-2 border-secondary" style="margin: 20px">
                    </form>
                </div>
            </div>
