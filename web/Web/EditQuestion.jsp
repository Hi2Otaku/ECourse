...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Edit Question</h1>
        </div>                
                ...
                <div class="counter bg-white rounded p-5">                    
                    ...
                    <form action="EditQuestion" method="post">
                        ...
                        <table style="width: 80%">
                            ...
                            <c:forEach items="${QuestionINS.loadQuestionAnswer(curCourse.getCourseID(), curLesson.getLessonID(), curQuiz.getQuizID(), curQues.getQuestionID())}" var="y">                                                                            
                                <tr>
                                    <th>Answer ${y.getAnswerID()}: </th>                                         
                                    <td>
                                        <input type="text" name="Answer${y.getAnswerID()}" value="${y.getDescription()}" class="form-control border-2 px-4" style="margin-top: 10px" required>                                                                            
                                    </td>                                                                
                                    <td style="width: 10px">
                                        <input type="radio" name="Correct" value="${y.getAnswerID()}" style=" margin-top: 10px"
                                               <c:if test="${y.getRole() == 2}">checked</c:if> required="true">
                                    </td>
                                </tr>
                            </c:forEach>                
                                <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" name="Status" value="1" 
                                           <c:if test="${curQues.getStatus() == 1}">checked</c:if> required> Active &nbsp;
                                           <input type="radio" name="Status" value="0"
                                           <c:if test="${curQues.getStatus() == 0}">checked</c:if>> Inactive &nbsp;
                                </td>
                            </tr>
                        </table>
                        <input type="submit" name="update" value="Update" class="btn btn-primary text-white border-2 border-secondary" style="margin: 20px">
                    </form>
                </div>
            </div>
