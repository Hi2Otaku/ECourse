<%-- 
    Document   : CreateQuiz
    Created on : Jul 5, 2024, 4:29:58 AM
    Author     : hi2ot
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Create Quiz</h1>
        </div>                
                ...
                <div class="counter bg-white rounded p-5">                    
                    <form action="CreateQuiz" method="post">
                        ...
                        <table style="width: 90%">
                            ...
                            <tr>
                                <th>Quiz Name: </th>
                                <td><input type="text" name="QuizName" value required="true" class="form-control border-2 px-4"> </td>
                            </tr>
                            <tr>
                                <th>Number of Questions: </th>
                                <td><input type="text" name="NoQ" value required="true" class="form-control border-2 px-4"> </td>
                            </tr>
                            <tr>
                                <th>Time Limit(second(s)): </th>
                                <td><input type="text" name="TimeLimit" value required="true" class="form-control border-2 px-4"> </td>
                            </tr>                        
                        </table>
                            <input type="submit" name="submit" value="Create New Quiz" class="btn btn-primary border-2 border-secondary text-white" style="margin: 20px">
                    </form>
                </div>
            </div>
